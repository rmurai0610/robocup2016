...
#define START_TILE_MASK     0x0040u
#define RAMP_TILE_MASK      0x0080u

void shift_maze_right(Maze, uint8);
void shift_maze_up(Maze, uint8);
...
uint8 is_start_tile(Maze, uint8, uint8, uint8);
...
void set_start_tile(Maze, uint8, uint8, uint8, uint8);
